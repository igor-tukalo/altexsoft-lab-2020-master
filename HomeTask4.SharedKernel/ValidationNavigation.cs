...
namespace HomeTask4.SharedKernel
{
    public class ValidationNavigation
    {
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public double ValidDouble(string number)
        {
            double numId = 0;
            bool validStart = false;
            while (!validStart)
        ...
        public string WrapText(int numChar, string text, string wrapChar = "\n")
        {
        ...
        /// <returns></returns>
        public string NullOrEmptyText(string text)
        {
            do
            {
                if (string.IsNullOrWhiteSpace(text))
        ...
        /// <returns></returns>
        public int BatchExist(string batch, int countBatch)
        {
